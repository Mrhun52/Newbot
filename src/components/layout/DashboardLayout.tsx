...
export const DashboardLayout = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-neutral-50 selection:bg-blue-500/30">
      ...
      {/* Mobile Header */}
      <div className="lg:hidden sticky top-0 z-40 bg-neutral-900/60 backdrop-blur-3xl border-b border-white/5 flex items-center justify-between px-4 py-4">
        <div className="w-8" />
      ...
      <main className="lg:pl-[18rem] min-h-screen relative z-10 pb-20 lg:pb-0 flex flex-col">
        ...
        <header className="hidden lg:flex items-center justify-between px-8 py-4 mx-4 mt-4 bg-neutral-900/40 backdrop-blur-3xl border border-white/5 rounded-3xl sticky top-0 z-30 shadow-2xl">
