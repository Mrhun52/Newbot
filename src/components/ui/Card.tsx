  ...
  ({ className, children, ...props }, ref) => {
    return (
      <motion.div
        ...
        className={cn(
          'relative bg-[#0F0F0F]/60 backdrop-blur-sm border border-white/10 rounded-2xl p-5 md:p-6 transition-all duration-300 hover:border-white/20 hover:bg-[#151515]/80 shadow-lg overflow-hidden group',
          className
        )}
        {...props}
      >
